...
{
    state.playCard(Card(Rank::KING, Suit::DIAMOND));
    state.playCard(Card(Rank::ACE, Suit::CLOVER));
    state.playCard(Card(Rank::QUEEN, Suit::DIAMOND));
    state.playCard(Card(Rank::TWO, Suit::SPADE));
