...
namespace spd
{
    ...
    private:
        static constexpr std::string BID_KEY = "M_BID";
        static constexpr std::string BIDOPT_KEY = BID_KEY + "OPT";
        static constexpr std::string CARD_KEY = "M_CARD";
        static constexpr std::string SEAT_KEY = "M_SEAT";
