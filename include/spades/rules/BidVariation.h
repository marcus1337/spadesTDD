...
namespace spd
{
    ...
    protected:
        ...
        std::vector<int> getBidEqualToSpades(const Seat &seat, const State &state, const std::vector<Card>& hand) const;
        virtual std::optional<int> getStandardBidResult(const Seat &seat, const State &state) const;

    public:
        virtual std::vector<int> getBids(const Seat &seat, const State &state, const std::vector<Card>& hand) const = 0;
